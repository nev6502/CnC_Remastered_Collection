...
void Call_Back(void)
{
	if (g_loadingPlague) {
		Hide_Mouse();
		Load_Title_Screen("LOADING.PCX", &HidPage, NULL);
		//Fancy_Text_Print(TXT_STAND_BY, (ScreenWidth / 2), (ScreenHeight / 2), &ColorRemaps[PCOLOR_DIALOG_BLUE], TBLACK, TPF_CENTER | TPF_TEXT | TPF_DROPSHADOW);
		Show_Mouse();
	}
